...
public class AbstractGenerator {
	...
	public String importGenerator(Entity entity,Mocha coral) {
...
//	}
	 ...
	 * @return
	 */
	public String genDBName(String propertyName) {
	...
	public static void main(String[] args) {
		...
		System.out.println(a.genDBName("User"));
		System.out.println(a.genDBName("UserName"));
		System.out.println(a.genDBName("UserNamePasswordAllOfThen"));
