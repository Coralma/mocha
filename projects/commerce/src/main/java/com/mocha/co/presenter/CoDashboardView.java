...
public class CoDashboardView extends CommonViewer implements Viewer {
	...
	public void attach() {
		...
		Panel columnPanel = buildPanel("Sales Monthly Distribution");
		...
		Panel piePanel = buildPanel("The Best Selling Products");
...
//		chartConfig.getSubtitle().setText("Source: WorldClimate.com");
	...
	private InvientCharts showPie() {
		...
		LinkedHashSet<DecimalPoint> points = new LinkedHashSet<DecimalPoint>();
		points.add(new DecimalPoint(series, "Bathroom Mirror", 30.0));
		points.add(new DecimalPoint(series, "Door Plaques", 18.0));
		points.add(new DecimalPoint(series, "Wall Decorations", 12.0));
		points.add(new DecimalPoint(series, "Garden Mirrors", 25.0));
		points.add(new DecimalPoint(series, "Cake Monogram", 7.0));
		points.add(new DecimalPoint(series, "Gifts", 3.0));
		points.add(new DecimalPoint(series, "Others", 5.0));
