...
import com.mocha.vaadin.entity.view.CommerceCustomerView;
...
public class CommerceCustomerViewPresenter extends AppCommonPresenter implements Presenter {

	private CommerceCustomerDao dao = SpringContextUtils.getBean(CommerceCustomerDao.class);
	
	public CommerceCustomerViewPresenter(MochaEventBus eventBus) {
		this.eventBus = eventBus;
		CommerceCustomerView newView = new CommerceCustomerView();
	...
	/**
	  * Save value of CommerceCustomerCreateView.
	  */
	public void save() {
		CommerceCustomer value = (CommerceCustomer)viewer.getValue();
		if(value != null) {
			dao.persist(value);
			back();
		}
