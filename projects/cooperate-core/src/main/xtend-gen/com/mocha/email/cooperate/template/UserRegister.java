...
public class UserRegister {
  ...
  public CharSequence getEmailContent(final BasicUser user) {
    ...
    _builder.append("</span><br/>");
    _builder.newLineIfNotEmpty();
    _builder.append("<div style=\"width=600px;\">Mocha Platform makes it easier to communicate, collaborate and software operation.By unifying all your workflows, by breaking-barriers of hierarchy, task, topic discuss and file management,you can now transform the way you communicate and collaborate with your colleagues.</div><br/>");
    _builder.newLine();
