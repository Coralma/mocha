...
//    	window.setContent(newUploader());
    	
    	UploadWithProgressMonitoringExample example = new UploadWithProgressMonitoringExample();
    	window.setContent(example);
    	
//    	build();
    }
    
    public VerticalLayout newUploader() { 
    	VerticalLayout layout = new VerticalLayout();
    	
    	final UploadField uploadField = new UploadField();
    	uploadField.setButtonCaption("File");
    	uploadField.addStyleName(BaseTheme.BUTTON_LINK);
