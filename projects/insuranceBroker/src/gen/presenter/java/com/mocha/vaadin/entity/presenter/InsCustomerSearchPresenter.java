...
import com.mocha.vaadin.entity.view.IbSocialNetworkProfilePresnter;
...
public class InsCustomerSearchPresenter extends AppCommonPresenter implements Presenter {
  ...
  private SoicalAppDao soicalDao = SpringContextUtils.getBean(SoicalAppDao.class);
  ...
  public void bind() {
    ...
    insCustomerSearch.getConditionPanel().getGlobleSearchWidget()
        .setListener(new GlobleSearchListener() {
          @Override
  ...
  public SearchFilterBuilder buildFuzzySearch(String condition) {
    SearchFilterBuilder filterBuilder =
        SearchFilterFactory.buildFuzzySearchFilter(InsuranceCustomer.class);
    ...
    filterBuilder.getSearchFilters().add(SearchFilter.like("linkedinProfileUrl", condition));
