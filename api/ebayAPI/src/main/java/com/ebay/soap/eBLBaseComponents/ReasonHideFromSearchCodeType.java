...
public enum ReasonHideFromSearchCodeType {
    ...
    /**
     * 
     * 						This value indicates that the auction listing is being hidden from search on the eBay site because the listing has been determined by eBay to be a duplicate listing with zero bids.
     * 					
     * 
     */
