...
public enum NotificationEventTypeCodeType {
     ...
     * 						ends due to a sale (fixed-price listing with 0 quantity left), a winning bid 
     * 						(auction listing), or the listing duration expiring with no buyer/winning bidder 
     * 						(fixed-price or auction listing). This notification is
     * 						sent shortly after the <b>ItemWon</b> (to buyer), 
     * 						<b>ItemSold<b> (to seller), and/or <b>ItemSold<b> 
     * 						(to seller) notifications are sent.
     * 						<br><br>
     * 						Applies to both Buyers and Sellers.
     * 					
     * 
