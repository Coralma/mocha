...
public class AppAuthenciateWindow extends Window implements ClickListener {
	...
	public void attach() {
		...
		if (userHasToken) {
			...
			NativeButton linkedinBtn = new NativeButton("Authencation On LinkedIn");
			...
			linkedinBtn.addListener(new ClickListener() {
				...
				public void buttonClick(ClickEvent event) {
					...
					System.out.println("linkedAuthUrl is: "+linkedAuthUrl);
					getApplication().getMainWindow().open(new ExternalResource(linkedAuthUrl));
				}
			});
		}
