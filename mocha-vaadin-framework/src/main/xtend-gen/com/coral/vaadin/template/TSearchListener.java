...
public class TSearchListener {
  ...
  public String init(final Entity entity, final List<Mocha> corals) {
    String _xblockexpression = null;
    {
      ...
      String _searchListenerName = this.searchListenerName = _genSearchListenerName;
      _xblockexpression = (_searchListenerName);
    }
  ...
  public CharSequence GENPackageImport() {
    ...
    _builder.append(SystemConstant.TSEARCH_LISTENER_PKG, "");
    _builder.append(";");
    _builder.newLineIfNotEmpty();
    _builder.newLine();
  ...
  public CharSequence GENClassHead() {
    StringConcatenation _builder = new StringConcatenation();
    GLog.startClass(this.searchListenerName);
    _builder.newLineIfNotEmpty();
    _builder.append("/**");
    _builder.newLine();
    _builder.append("  ");
  ...
  public CharSequence GENClassEnd() {
    StringConcatenation _builder = new StringConcatenation();
    GLog.endClass(this.searchListenerName);
    _builder.newLineIfNotEmpty();
    _builder.append("}");
    _builder.newLine();
    return _builder;
