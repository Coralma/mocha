...
/**
 * Unit tests for checking that JAXB type adapters work (to some degree, anyway). Related to issues [JACKSON-288], [JACKSON-411]
 * 
 * @author tsaloranta
 * 
 * @since 1.6.3
...
public class TestAdapters extends BaseJaxbTest {
	...
	private void assertEquals(String string, String writeValueAsString) {
		System.out.println(string);
		System.out.println(writeValueAsString);
	}

	private void assertEquals(long l, long writeValueAsString) {
	...
	private void assertNotNull(Date value) {
		// TODO Auto-generated method stub
		System.out.println(value);
	}

	private void assertNotNull(Bean288 output) {
		// TODO Auto-generated method stub
